...
void (*JIT::Generators::PeakPerformance::generateNoMem(uint32_t operational_intensity)) (float const * a, float const * b, float * c, float const scalar, uint32_t size) {
    backend.resetKernel();
...
void (*JIT::Generators::PeakPerformance::generateSteps(float operational_intensity)) (float const * a, float const * b, float * c, float const scalar, uint32_t size) {
    backend.resetKernel();
...
void (*JIT::Generators::PeakPerformance::generateStepsNoMem(float operational_intensity)) (float const * a, float const * b, float * c, float const scalar, uint32_t size) {
    backend.resetKernel();
