...
void setupProfilingMVEStalls() {
	...
	ARM_PMU_Set_EVTYPER(9, ARM_PMU_STALL);
	ARM_PMU_Set_EVTYPER(10, ARM_PMU_STALL_BACKEND);
	ARM_PMU_Set_EVTYPER(11, ARM_PMU_STALL_FRONTEND);
	ARM_PMU_Set_EVTYPER(12, ARM_PMU_STALL_OP);
	ARM_PMU_Set_EVTYPER(13, ARM_PMU_STALL_OP_BACKEND);
	ARM_PMU_Set_EVTYPER(14, ARM_PMU_STALL_OP_FRONTEND);
	ARM_PMU_Set_EVTYPER(15, ARM_PMU_MVE_INST_RETIRED);
	ARM_PMU_Set_EVTYPER(16, ARM_PMU_MVE_LDST_RETIRED);
}
...
void startCounting() {
	...
	ARM_PMU_CNTR_Enable(PMU_CNTENSET_CCNTR_ENABLE_Msk | PMU_CNTENSET_CNT0_ENABLE_Msk | PMU_CNTENSET_CNT1_ENABLE_Msk | PMU_CNTENSET_CNT2_ENABLE_Msk | PMU_CNTENSET_CNT3_ENABLE_Msk 
		| PMU_CNTENSET_CNT4_ENABLE_Msk | PMU_CNTENSET_CNT5_ENABLE_Msk | PMU_CNTENSET_CNT6_ENABLE_Msk | PMU_CNTENSET_CNT7_ENABLE_Msk | PMU_CNTENSET_CNT8_ENABLE_Msk | PMU_CNTENSET_CNT9_ENABLE_Msk
		| PMU_CNTENSET_CNT10_ENABLE_Msk | PMU_CNTENSET_CNT11_ENABLE_Msk | PMU_CNTENSET_CNT12_ENABLE_Msk | PMU_CNTENSET_CNT13_ENABLE_Msk | PMU_CNTENSET_CNT14_ENABLE_Msk | PMU_CNTENSET_CNT15_ENABLE_Msk
		| PMU_CNTENSET_CNT16_ENABLE_Msk);
